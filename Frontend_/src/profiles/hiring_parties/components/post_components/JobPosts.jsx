...
const JobPosts = ({ posts, onCreateNew }) => {
  return (
    <div className="job-feed">
      <h3 className="feed-title">Recent Job post</h3>
            ...
            <div className="md:flex">
              <div className="md:flex-shrink-0 md:w-48 relative">
                {post?.posterImageBase64 ? (
                  ...
                  <div className="job-image-placeholder">
                    ...
                    <span className="text-sm text-indigo-200 mt-2">No Image</span>
                  </div>
                )}
              </div>
              ...
              <div className="job-details">
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-white">{post.title || 'No Title'}</h3>
                    <div className="mt-2 flex items-center text-sm text-indigo-200">
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center space-x-3">
                    <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-indigo-900/50 text-indigo-300">
                      {post.type || 'Full-time'}
                    </span>
